...
SYNOPSIS
    ./new_project.sh [--install | --update | --update-skeleton | --update-submodules] [--project-readable-name readable_name] [--gae-app-name gae_app_name] [--] <github-rep> [<path>]
